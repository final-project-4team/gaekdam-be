...
CREATE INDEX idx_customer_hotel_updated_code
    ON customer (hotel_group_code, updated_at, customer_code);

-- 자주 쓰는 필터들
CREATE INDEX idx_customer_hotel_status_code
    ON customer (hotel_group_code, customer_status, customer_code);
