...
class LoyaltyGradeCommandServiceTest {
    ...
    void create_success() {
        ...
        when(req.loyaltyCalculationTermMonth()).thenReturn(12);
        when(req.loyaltyCalculationRenewalDay()).thenReturn(15);
        ...
        assertThat(saved.getLoyaltyCalculationRenewalDay()).isEqualTo(15);
    ...
    void delete_hotelGroupCodeNotMatch_thenThrow() {
        ...
        LoyaltyGrade grade = LoyaltyGrade.registerLoyaltyGrade(
                otherGroup, "EXCELLENT", 3L, "c", 1L, 1, 12, 10
        );
    ...
    void update_hotelGroupCodeNotMatch_thenThrow() {
        ...
        LoyaltyGrade grade = LoyaltyGrade.registerLoyaltyGrade(
                otherGroup, "OLD", 1L, "old", 1L, 1, 12, 10
        );
        when(loyaltyGradeRepository.findById(loyaltyGradeCode)).thenReturn(Optional.of(grade));
    ...
    void update_success() {
        ...
        when(req.loyaltyCalculationTermMonth()).thenReturn(6);
        ...
        assertThat(grade.getLoyaltyCalculationTermMonth()).isEqualTo(6);
        assertThat(grade.getLoyaltyCalculationRenewalDay()).isEqualTo(20);
