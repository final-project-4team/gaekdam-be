...
class MembershipGradeCommandServiceTest {
    ...
    void create_gradeName_null_thenThrow() {
        // given
        MembershipGradeRequest req = new MembershipGradeRequest(null, 1L, "comment", 1000L, 1, 12, 1);
    ...
    void create_gradeName_blank_thenThrow() {
        // given
        MembershipGradeRequest req = new MembershipGradeRequest("   ", 1L, "comment", 1000L, 1, 12, 1);
    ...
    void create_tierLevel_null_thenThrow() {
        // given
        MembershipGradeRequest req = new MembershipGradeRequest("GOLD", null, "comment", 1000L, 1, 12, 1);
    ...
    void create_tierComment_blank_thenThrow() {
        // given
        MembershipGradeRequest req = new MembershipGradeRequest("GOLD", 1L, "   ", 1000L, 1, 12, 1);
    ...
    void create_termMonth_null_thenThrow() {
        // given
        MembershipGradeRequest req = new MembershipGradeRequest("GOLD", 1L, "tier", 1000L, 1, null, 1);
    ...
    void create_renewalDay_null_thenThrow() {
        // given
        MembershipGradeRequest req = new MembershipGradeRequest("GOLD", 1L, "tier", 1000L, 1, 12, null);
    ...
    void update_gradeName_blank_thenThrow() {
        ...
        MembershipGradeRequest req = new MembershipGradeRequest("   ", 1L, "tier", 1000L, 1, 12, 1);
