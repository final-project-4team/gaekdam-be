...
class MembershipGradeCommandServiceTest {
  ...
  void setUp() {
    ...
    service = new MembershipGradeCommandService(membershipBatchMapper,membershipRepository,membershipHistoryRepository, hotelGroupRepository,
        membershipGradeRepository,employeeRepository,auditLogService);
  }
  ...
  void update_grade_notFound() {
    ...
    // when & then
    assertThatThrownBy(() -> service.updateMembershipGrade(1L, 10L, req,accessorId))
        .isInstanceOf(IllegalArgumentException.class)
